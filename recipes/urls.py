...
from recipes.views import home, login, sair, cliente_editar, cliente_excluir, funcionario_excluir, fornecedor_excluir, fornecedor_editar, funcionario_editar, cliente_cadastro, funcionario_cadastro, funcionario_consulta, fornecedor_cadastro, usuario_cadastro, cliente_consulta, fornecedor_consulta
...
urlpatterns = [
    ...
    path('cliente/excluir/<int:id>/', cliente_excluir, name='cliente_excluir'),
    path('fornecedor/excluir/<int:id>/', fornecedor_excluir, name='fornecedor_excluir'),
    path('funcionario/excluir/<int:id>/', funcionario_excluir, name='funcionario_excluir'),
]